...
router.post('/api/changeTimeFrame', apiKeys.changeTimeFrame);

router.post('/api/setDiscordToken', apiKeys.setDiscordToken);
router.post('/api/changeSetupTrade', apiKeys.changeSetupTrade);
