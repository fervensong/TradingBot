...
Trader.prototype.processAlert = function(alertData)  {
  console.log("----processAlert---");
}
Trader.prototype.processAdvice = function(advice) {
  let direction;
    console.log("---processAdvice");
...
console.log(this.order);
  ...
  if(direction === 'buy') {
    ...
    amount = this.portfolio.currency * 0.95;
...
Trader.prototype.createOrder = function(side, amount, advice, id) {
  ...
  console.log("--createOrder:" + type+", amount:"+amount);
